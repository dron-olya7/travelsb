<div class="row">
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 right">
        <?php
            ...
            $selectCities = 'select cities.id, cities.city, countries.country from countries, cities where cities.countryid = countries.id order by cities.id asc';
...
<div class="row">
    <div class="col-sm-6 col-md-6 col-lg-6 left">
        <?php
            ...
            $selectHotels = 'select cities.id, cities.city, hotels.id, hotels.hotel, hotels.cityid, hotels.countryid, 
            hotels.stars, hotels.info, countries.id, countries.country
            from cities, hotels, countries
            where hotels.cityid = cities.id and hotels.countryid = countries.id';
